...
static const void *const sItemIconGfxPtrs[][2] = {
    ...
    {gFile_graphics_items_icons_question_mark_sheet, gFile_graphics_items_icon_palettes_question_mark_palette},
    {gFile_graphics_items_icons_blue_key_sheet, gFile_graphics_items_icon_palettes_blue_key_palette},
    {gFile_graphics_items_icons_yellow_key_sheet, gFile_graphics_items_icon_palettes_yellow_key_palette},
    ...
    {gFile_graphics_items_icons_red_key_sheet, gFile_graphics_items_icon_palettes_red_key_palette},
