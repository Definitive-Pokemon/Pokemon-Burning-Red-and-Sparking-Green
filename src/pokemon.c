...
#include "data/pokemon/form_order.h"
...
const u32 *GetMonSpritePalFromSpeciesAndPersonality(u16 species, u32 otId, u32 personality)
{
    ...
    if (FORM_PART(species))
    {
        u8 formIndex = GetFormIndex(species);
        if (shinyValue < 8)
            return gMonShinyPaletteTable[FORM_SPECIES_SPRITE_INDEX(formIndex)].data;
        else
            return gMonPaletteTable[FORM_SPECIES_SPRITE_INDEX(formIndex)].data;
    }
