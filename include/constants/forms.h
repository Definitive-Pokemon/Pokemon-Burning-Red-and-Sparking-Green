...
#define DEOXYS_HIGHEST_FORME_NUM SPECIES_DEOXYS_SPEED_FORME

#define SPECIES_PART_INCLUDING_DEOXYS(formSpecies) (species & ((u16) (1 << (FORM_FLAG_SHIFT - FORM_NUM_BITS)) - 1))
